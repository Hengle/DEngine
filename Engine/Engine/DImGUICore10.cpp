...
void DImGUICore10::Init(HWND hwnd, ID3D10Device * device)
{
	IMGUI_CHECKVERSION();
	ImGui::CreateContext();
	...
	ImGui_ImplDX10_Init(hwnd, device);

	// Setup style
	ImGui::StyleColorsDark();
}

void DImGUICore10::ShutDown()
{
	ImGui_ImplDX10_Shutdown();
	ImGui::DestroyContext();
}

void DImGUICore10::NewFrame()
{
	ImGui_ImplDX10_NewFrame();
}

void DImGUICore10::EndFrame()
{
}

void DImGUICore10::Render()
{
	ImGui::Render();
	ImGui_ImplDX10_RenderDrawData(ImGui::GetDrawData());
}

IMGUI_API bool DImGUICore10::ImGui_ImplDX10_Init(void * hwnd, ID3D10Device * device)
{
	g_hWnd = (HWND)hwnd;
	g_pd3dDevice = device;
...
IMGUI_API void DImGUICore10::ImGui_ImplDX10_Shutdown()
{
...
IMGUI_API void DImGUICore10::ImGui_ImplDX10_NewFrame()
{
	if (!g_pFontSampler)
...
IMGUI_API void DImGUICore10::ImGui_ImplDX10_RenderDrawData(ImDrawData * draw_data)
{
...
IMGUI_API void DImGUICore10::ImGui_ImplDX10_InvalidateDeviceObjects()
{
	if (!g_pd3dDevice)
		return;
...
IMGUI_API bool DImGUICore10::ImGui_ImplDX10_CreateDeviceObjects()
{
	if (!g_pd3dDevice)
		return false;
	if (g_pFontSampler)
...
void DImGUICore10::ImGui_ImplDX10_CreateFontsTexture()
{
	ImGuiIO& io = ImGui::GetIO();
